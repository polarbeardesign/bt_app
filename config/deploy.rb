...
set :repository, "git@github.com:polarbeardesign/bt_app.git" # Your clone URL
set :scm, "git"
set :branch, "master"
...
after "deploy:restart", "deploy:cleanup", "deploy:symlink_env_file", "deploy:symlink_htaccess_file", "deploy:symlink_db_file_II"
